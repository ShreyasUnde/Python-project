...
class Employee:
    def __init__(self,root):
        ...
        img_logo = img_logo.resize((50, 50), Resampling.LANCZOS)
        ...
        img1=img1.resize((540,160),Resampling.LANCZOS)
        ...
        img_2=img_2.resize((540,160),Resampling.LANCZOS)
        ...
        img_3=img_3.resize((540,160),Resampling.LANCZOS)
        ...
        combo_dep['value']=('Select Department','HR','Software Engineer','IT','Marketing','Operations','Finance','Sales')
        combo_dep.current(0)
        ...
        # lbl_Designation
        lbl_designation=Label(upper_frame,font=('arial',12,'bold'),text='Desgination:',bg='white')
        ...
        # my_button =Button(root,text="Register To Check Leave Status", fg="white",bg="#6CBB3C",
